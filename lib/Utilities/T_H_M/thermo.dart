...
class ThermoPainter extends CustomPainter {
  ...
  void _drawReflections(ui.Size size, ui.Canvas canvas) {
    var reflectTopLeft1 = Offset(
      size.width / 2,
      vPadding + thickness + 30,
    );
    var reflectBottomRight1 = Offset(
      size.width / 2 + 28,
      size.height - vPadding - thickness - 30,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromPoints(reflectTopLeft1, reflectBottomRight1),
        const Radius.circular(18),
      ),
      Paint()
        ..shader = ui.Gradient.linear(
          reflectTopLeft1,
          reflectTopLeft1 + const Offset(30, 0),
    ...
    var reflectTopLeft2 = Offset(
      size.width / 2 - 30,
      vPadding + thickness + 30,
    );
    var reflectBottomRight2 = Offset(
      size.width / 2 - 12,
      size.height - vPadding - thickness - 30,
    );
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromPoints(reflectTopLeft2, reflectBottomRight2),
        const Radius.circular(8),
      ),
      Paint()
        ..shader = ui.Gradient.linear(
          reflectTopLeft2,
          reflectTopLeft2 + const Offset(20, 0),
